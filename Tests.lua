...
function TEST_PRIEST_ALONE_ROTATION()
  ...
  TESTAssert("64044", tostring(objOrderedCCSpells[1].Spell.SpellId), "Initial CC Spell before cooldowns should be Intimidating Shout")  
  TESTAssert("Psychic Horror", tostring(objOrderedCCSpells[1].Spell.CCName), "Horror first");
   TESTAssert("PRIEST123", tostring(objOrderedCCSpells[1].Friend.GUID), "Friend GUID of Initial CC Spell before cooldowns")  
  ...
  TESTAssert("Silence", tostring(objOrderedCCSpells[1].Spell.CCName), "Spell Name");
  ...
  TESTAssert(0, table.getn(GVAR.MessageLog), "Should send no new message");
  ...
  --print("DEBUG: Silence in 2, but we should ACT NOW");
  ...
  objOrderedCCSpells = objPvPHelperServer:OrderedCCSpells(objFoe.GUID);  
  TESTAssert("8122", tostring(objOrderedCCSpells[1].Spell.SpellId), "Spell Id");
  TESTAssert("Psychic Scream", tostring(objOrderedCCSpells[1].Spell.CCName), "Spell Name");
